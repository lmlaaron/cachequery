...
# r 12 v 13 v 13 12 v v 10 v 10 13 11 v 11 r 9 v 9 15 v 15 14 v 14
# 
...
for i in `seq 0 124`; do
	for v in `seq 0 7`; do
		...
		z=$(./cachequery.py -l l3 -r 0_${r1} 1_4 0_${v} 1_5 0_${v} 1_5? 1_4? 0_${v} 0_${v} 1_2 0_${v} 1_2?  1_5 1_3 0_${v} 1_3? 0_${r2} 1_1 0_${v} 1_1? 1_7 0_${v} 1_7? 1_6 0_${v} 1_6? | tail -1 | awk '{print $28 "\t" $29  "\t"  $30 "\t" $31 "\t" $32 "\t" $33 "\t" $34 }')
		echo $z	
		...
		if [ $v -eq 0 ] && [ $l1 -ne 0 ]  && [ $l2 -ne 0 ]   && [ $l3 -ne 0 ] && [ $l4 -ne 0 ]&& [ $l5 -ne 0 ] && [ $l6 -ne 0 ]&& [ $l7 -ne 0 ]
		then
